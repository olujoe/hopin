...
Scenario Outline: Welcome Screen test and customer details happy path
    Given user navigates to the Customer App page
    When user enters <name> in the name field
    When user clicks on Submit button
    And Welcome to Customer App page with customer <name> appears
...
Scenario: Welcome Screen test and customer details Unhappy path
    Given user navigates to the Customer App page
    When user enters "John Doe" in the name field
    When user clicks on Submit button
    And Welcome to Customer App page with customer "John Doe" appears
    Then I display any errors in the tables
    Then I can view broken Customer Details from the list

# ************************************************************************************************
# *** NOTE: The scenarios below were used to develop the tests and are kep here for reference ****
# ************************************************************************************************
